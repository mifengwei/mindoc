                                    ...
                                    <div class="extra">
                                        <div>
                                            <div class="ui horizontal small list">
                                                ...
                                                <div class="item"><a href="{{urlfor "BlogController.ManageEdit"}}/{{$item.BlogId}}" title="{{i18n $.Lang "blog.edit_blog"}}" target="_blank"><i class="fa fa-edit"></i> {{i18n $.Lang "blog.edit"}}</a></div>
                                                ...
                                                <div class="item"><a href="{{urlfor "BlogController.ManageSetting"}}/{{$item.BlogId}}" title="{{i18n $.Lang "blog.setting_blog"}}" class="setting-btn"><i class="fa fa-gear"></i> {{i18n $.Lang "common.setting"}}</a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
